...
// const Size1156Screen = () => {
//   return (
//     <View style={styles.container}>
//       <Text style={styles.title}>Ring Size 9.92 mm</Text>
//       <Text style={styles.description}>
//         This is a special size. Explore rings that fit this size perfectly.
//       </Text>
//     </View>
//   );
// };
...
const Size1156Screen = ({ navigation }: any) => {
  const [location, setLocation] = useState('Kalyan - 421201');
  const [isModalVisible, setModalVisible] = useState(false);
  const [selectedProduct, setSelectedProduct] = useState<Product | null>(null);
  const { cart, addToCart } = useCart(); // Using CartContext for cart actions
